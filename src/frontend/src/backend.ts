...
export class Backend implements backendInterface {
    ...
    async addCourse(arg0: string, arg1: string, arg2: bigint, arg3: string, arg4: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addCourse(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getAllCountryPricing(): Promise<Array<CountryPricing>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllCountryPricing();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCountryPricing(arg0: string): Promise<CountryPricing> {
        if (this.processError) {
            try {
                const result = await this.actor.getCountryPricing(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
